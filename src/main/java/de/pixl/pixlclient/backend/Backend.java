...
public class Backend {
    ...
    public void connect() {
        ...
        client = new OkHttpClient.Builder()
                ...
                .build();
        Request request = new Request.Builder().url("wss://cosmetic.craftsblock.de/v1/cosmetic").build();
    ...
    public void disconnect() {
        ...
        try {
            ...
            if (!success)
                throw new IllegalStateException("Thw Websocket could not be terminated properly!");
        } catch (Exception e) {
            e.printStackTrace();
        }
        socket = null;
